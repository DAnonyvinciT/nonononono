...
def calculate_upper_lower_distance(
    ...
    #_, path = ddtw(gt_smooth, pred_smooth)
    # --- Detect extrema -------------------------------------------------------
...
if __name__ == '__main__':
    ...
    # GT_DIR = workspace_root / 'faceformer/vocaset/result_gt'
    # PRED_DIR = workspace_root / 'faceformer/vocaset/result'
    # OUT_DIR = script_dir / 'data_MTM/output_faceformer_with_VOCASET'
    # CSV_PATH = OUT_DIR / 'delta_t_results_faceformer_with_VOCASET.csv'

    # GT_DIR = workspace_root / 'modelmead/result_full_gt'
    # PRED_DIR = workspace_root / 'modelmead/result_full'
    # OUT_DIR = script_dir / 'data_MTM/output_faceformer_with_Mead3D'
    # CSV_PATH = OUT_DIR / 'delta_t_results_faceformer_with_Mead3D.csv'
