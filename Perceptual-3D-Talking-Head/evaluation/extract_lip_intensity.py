...
#预测顶点
# source_root = '/home/tkface/workspace/FaceFormer/modelmead/result_full'
# destination_root = './lip_disp'
#原始顶点
source_root = os.path.expanduser('~/datasets/mead_clean/vertex')
destination_root = './lip_disp_gt'
