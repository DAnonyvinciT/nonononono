...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="提取 MEAD 原始视频的音频 RMS")
    parser.add_argument(
        "--video-directory",
        default=os.path.expanduser("~/datasets/MEAD_Org"),
        help="MEAD 原始视频根目录",
    )
    parser.add_argument(
        "--output-directory",
    ...
    process_directory(args.video_directory, args.output_directory)
